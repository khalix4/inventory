...
<!-- <footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto align-text-bottom">
...
<div id="overlay" onclick="off()">
    <div id="text" class="container mt-5">
        <div class="card border-0 shadow-lg p-4 text-center">
            <div class="card-body">
                <h5 class="card-title text-dark font-weight-bold">Welcome!</h5>
                <p class="card-text text-muted">
                    <strong><?php echo $_SESSION['FIRST_NAME']. ' '.$_SESSION['LAST_NAME']; ?></strong><br>
                    From <strong><?php echo $_SESSION['PROVINCE']. ' '.$_SESSION['CITY']; ?></strong>
                </p>
            </div>
        </div>
    </div>
